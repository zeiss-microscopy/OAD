...
def runSWAF_special(
    ...
    # set SWAF parameters
    SWAF_exp.SetAutofocusParameters(
...
def modify_tileexperiment_rect(tileexp, blockindex=0, bcwidth=1.0, bcheight=1.0, xpos=1.0, ypos=1.0, zpos=1.0):
...
def modify_tileexperiment_polygon(tileexp, polyregion, blockindex=0, zpos=0.0):
    """Modify an existing ZenExperiment with an existing Tileregion by adding
    ...
    for obj in range(SingleObj.RowCount):
        ...
        if DetailIsTileExp:
            ...
            if use_polygon:
                ...
                DetailScan_reloaded = modify_tileexperiment_polygon(
                    DetailScan_reloaded, polyregions[obj], blockindex=0, zpos=zpos
                )
            else:
                # modify the experiment
                DetailScan_reloaded = modify_tileexperiment_rect(
                    DetailScan_reloaded,
