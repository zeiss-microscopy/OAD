...
# sources: zen_api/hardware/v1/axis_identifier.proto, zen_api/hardware/v1/simple_stage_service.proto, zen_api/hardware/v1/stage_axis.proto, zen_api/hardware/v1/stage_motion_state.proto, zen_api/hardware/v1/stage_service.proto, zen_api/hardware/v1/stage_state.proto
...
@dataclass(eq=False, repr=False)
class SimpleStageServiceGetAccelerationRequest(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class SimpleStageServiceGetAccelerationResponse(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class SimpleStageServiceGetPositionRequest(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class SimpleStageServiceGetPositionResponse(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class SimpleStageServiceGetSpeedRequest(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class SimpleStageServiceGetSpeedResponse(betterproto.Message):
    """Speed of the stage."""
...
@dataclass(eq=False, repr=False)
class SimpleStageServiceMoveToRequest(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class SimpleStageServiceMoveToResponse(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class SimpleStageServiceSetAccelerationRequest(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class SimpleStageServiceSetAccelerationResponse(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class SimpleStageServiceSetSpeedRequest(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class SimpleStageServiceSetSpeedResponse(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class SimpleStageServiceStopRequest(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class SimpleStageServiceStopResponse(betterproto.Message):
...
class SimpleStageServiceStub(betterproto.ServiceStub):
    async def get_acceleration(
        self,
        simple_stage_service_get_acceleration_request: "SimpleStageServiceGetAccelerationRequest",
        *,
        ...
        return await self._unary_unary(
            "/zen_api.hardware.v1.SimpleStageService/GetAcceleration",
            simple_stage_service_get_acceleration_request,
            SimpleStageServiceGetAccelerationResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_position(
        self,
        simple_stage_service_get_position_request: "SimpleStageServiceGetPositionRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            "/zen_api.hardware.v1.SimpleStageService/GetPosition",
            simple_stage_service_get_position_request,
            SimpleStageServiceGetPositionResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_speed(
        self,
        simple_stage_service_get_speed_request: "SimpleStageServiceGetSpeedRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            "/zen_api.hardware.v1.SimpleStageService/GetSpeed",
            simple_stage_service_get_speed_request,
            SimpleStageServiceGetSpeedResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def move_to(
        self,
        simple_stage_service_move_to_request: "SimpleStageServiceMoveToRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            "/zen_api.hardware.v1.SimpleStageService/MoveTo",
            simple_stage_service_move_to_request,
            SimpleStageServiceMoveToResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def set_acceleration(
        self,
        simple_stage_service_set_acceleration_request: "SimpleStageServiceSetAccelerationRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            "/zen_api.hardware.v1.SimpleStageService/SetAcceleration",
            simple_stage_service_set_acceleration_request,
            SimpleStageServiceSetAccelerationResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def set_speed(
        self,
        simple_stage_service_set_speed_request: "SimpleStageServiceSetSpeedRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            "/zen_api.hardware.v1.SimpleStageService/SetSpeed",
            simple_stage_service_set_speed_request,
            SimpleStageServiceSetSpeedResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def stop(
        self,
        simple_stage_service_stop_request: "SimpleStageServiceStopRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            "/zen_api.hardware.v1.SimpleStageService/Stop",
            simple_stage_service_stop_request,
            SimpleStageServiceStopResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
...
class SimpleStageServiceBase(ServiceBase):
    ...
    async def move_to(
        self, simple_stage_service_move_to_request: "SimpleStageServiceMoveToRequest"
    ) -> "SimpleStageServiceMoveToResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def stop(
        self, simple_stage_service_stop_request: "SimpleStageServiceStopRequest"
    ) -> "SimpleStageServiceStopResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def __rpc_get_acceleration(
        self,
        stream: "grpclib.server.Stream[SimpleStageServiceGetAccelerationRequest, SimpleStageServiceGetAccelerationResponse]",
    ) -> None:
    ...
    async def __rpc_get_position(
        self,
        stream: "grpclib.server.Stream[SimpleStageServiceGetPositionRequest, SimpleStageServiceGetPositionResponse]",
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_speed(
        self,
        stream: "grpclib.server.Stream[SimpleStageServiceGetSpeedRequest, SimpleStageServiceGetSpeedResponse]",
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_move_to(
        self,
        stream: "grpclib.server.Stream[SimpleStageServiceMoveToRequest, SimpleStageServiceMoveToResponse]",
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_set_acceleration(
        self,
        stream: "grpclib.server.Stream[SimpleStageServiceSetAccelerationRequest, SimpleStageServiceSetAccelerationResponse]",
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_set_speed(
        self,
        stream: "grpclib.server.Stream[SimpleStageServiceSetSpeedRequest, SimpleStageServiceSetSpeedResponse]",
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_stop(
        self,
        stream: "grpclib.server.Stream[SimpleStageServiceStopRequest, SimpleStageServiceStopResponse]",
    ) -> None:
        request = await stream.recv_message()
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/zen_api.hardware.v1.SimpleStageService/GetAcceleration": grpclib.const.Handler(
                self.__rpc_get_acceleration,
                grpclib.const.Cardinality.UNARY_UNARY,
                SimpleStageServiceGetAccelerationRequest,
                SimpleStageServiceGetAccelerationResponse,
            ),
            "/zen_api.hardware.v1.SimpleStageService/GetPosition": grpclib.const.Handler(
                self.__rpc_get_position,
                grpclib.const.Cardinality.UNARY_UNARY,
                SimpleStageServiceGetPositionRequest,
                SimpleStageServiceGetPositionResponse,
            ),
            "/zen_api.hardware.v1.SimpleStageService/GetSpeed": grpclib.const.Handler(
                self.__rpc_get_speed,
                grpclib.const.Cardinality.UNARY_UNARY,
                SimpleStageServiceGetSpeedRequest,
                SimpleStageServiceGetSpeedResponse,
            ),
            "/zen_api.hardware.v1.SimpleStageService/MoveTo": grpclib.const.Handler(
                self.__rpc_move_to,
                grpclib.const.Cardinality.UNARY_UNARY,
                SimpleStageServiceMoveToRequest,
                SimpleStageServiceMoveToResponse,
            ),
            "/zen_api.hardware.v1.SimpleStageService/SetAcceleration": grpclib.const.Handler(
                self.__rpc_set_acceleration,
                grpclib.const.Cardinality.UNARY_UNARY,
                SimpleStageServiceSetAccelerationRequest,
                SimpleStageServiceSetAccelerationResponse,
            ),
            "/zen_api.hardware.v1.SimpleStageService/SetSpeed": grpclib.const.Handler(
                self.__rpc_set_speed,
                grpclib.const.Cardinality.UNARY_UNARY,
                SimpleStageServiceSetSpeedRequest,
                SimpleStageServiceSetSpeedResponse,
            ),
            "/zen_api.hardware.v1.SimpleStageService/Stop": grpclib.const.Handler(
                self.__rpc_stop,
                grpclib.const.Cardinality.UNARY_UNARY,
