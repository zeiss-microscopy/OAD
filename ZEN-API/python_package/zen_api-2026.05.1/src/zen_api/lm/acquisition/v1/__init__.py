...
# sources: zen_api/lm/acquisition/v1/autofocus_contrast_measure.proto, zen_api/lm/acquisition/v1/autofocus_mode.proto, zen_api/lm/acquisition/v1/autofocus_sampling.proto, zen_api/lm/acquisition/v1/channel_info.proto, zen_api/lm/acquisition/v1/definite_focus_service.proto, zen_api/lm/acquisition/v1/experiment_sw_autofocus_service.proto, zen_api/lm/acquisition/v1/position3d.proto, zen_api/lm/acquisition/v1/region_contour.proto, zen_api/lm/acquisition/v1/region_point.proto, zen_api/lm/acquisition/v1/region_rect.proto, zen_api/lm/acquisition/v1/tiles_service.proto, zen_api/lm/acquisition/v1/time_series_info.proto, zen_api/lm/acquisition/v1/time_series_service.proto, zen_api/lm/acquisition/v1/time_series_service_time_series_info.proto, zen_api/lm/acquisition/v1/time_series_service_time_unit.proto, zen_api/lm/acquisition/v1/time_series_service_time_unit_extended.proto, zen_api/lm/acquisition/v1/time_unit.proto, zen_api/lm/acquisition/v1/time_unit_extended.proto, zen_api/lm/acquisition/v1/track_info.proto, zen_api/lm/acquisition/v1/track_service.proto, zen_api/lm/acquisition/v1/zstack_service.proto
...
class TimeUnitExtended(betterproto.Enum):
    ...
    CYCLES = 1
    """Cycles is the count of time points."""
...
class TimeSeriesServiceTimeUnitExtended(betterproto.Enum):
    """Extended time units to match TimeUnitExtended enum."""
...
class TimeSeriesServiceTimeUnit(betterproto.Enum):
    """Extended time units to match TimeUnit enum."""
...
@dataclass(eq=False, repr=False)
class DefiniteFocusServiceFindSurfaceRequest(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class DefiniteFocusServiceFindSurfaceResponse(betterproto.Message):
    """Response for FindSurface."""

    zposition: float = betterproto.double_field(1)
    """The Z position."""


@dataclass(eq=False, repr=False)
class DefiniteFocusServiceLockFocusRequest(betterproto.Message):
    """The DefiniteFocusServiceLockFocusRequest class."""

    timeout: int = betterproto.int32_field(1)
    """Timeout in seconds."""


@dataclass(eq=False, repr=False)
class DefiniteFocusServiceLockFocusResponse(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class DefiniteFocusServiceRecallFocusRequest(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class DefiniteFocusServiceRecallFocusResponse(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class DefiniteFocusServiceStoreFocusRequest(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class DefiniteFocusServiceStoreFocusResponse(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class DefiniteFocusServiceUnlockFocusRequest(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class DefiniteFocusServiceUnlockFocusResponse(betterproto.Message):
...
class RegionContour(betterproto.Message):
    ...
    region_ellipse: "RegionEllipse" = betterproto.message_field(1, group="subtype")
    region_rectangle: "RegionRectangle" = betterproto.message_field(2, group="subtype")
    region_polygon: "RegionPolygon" = betterproto.message_field(3, group="subtype")
...
class RegionEllipse(betterproto.Message):
    ...
    The rectangle that defines the bounding box of the ellipse.
     ...
     The ZenApi.LM.Acquisition.V1.RegionRect specifies the position and size of the bounding rectangle
...
class RegionPolygon(betterproto.Message):
    ...
    """
    The ordered list of ZenApi.LM.Acquisition.V1.RegionPoint instances that define the vertices of the polygon.
...
class RegionRectangle(betterproto.Message):
    ...
    """
    The ZenApi.LM.Acquisition.V1.RegionRect that defines the position and size of the rectangular region
     within the slide scan area.
    """
...
@dataclass(eq=False, repr=False)
class TimeSeriesInfo(betterproto.Message):
    """Object representing the value of TimeSeriesInfo for the experiment."""

    duration: float = betterproto.double_field(1)
    """The value of the Duration."""

    duration_unit: "TimeUnitExtended" = betterproto.enum_field(2)
    """The value of the Duration Unit of measure."""

    is_long_as_possible: bool = betterproto.bool_field(3)
    """A value indicating whether the duration is as long as possible."""

    interval: float = betterproto.double_field(4)
    """The value of the Interval."""

    interval_unit: "TimeUnit" = betterproto.enum_field(5)
    """The value of the Interval Uunit of measure."""

    is_fast_as_possible: bool = betterproto.bool_field(6)
    """A value indicating whether the imaging is as fast as possible."""

    is_burst_mode: bool = betterproto.bool_field(7)
    """A value indicating whether Burst Mode is used."""


@dataclass(eq=False, repr=False)
class TimeSeriesServiceGetTimeSeriesInfoRequest(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class TimeSeriesServiceGetTimeSeriesInfoResponse(betterproto.Message):
    """
    Response object containing the value of Time Series info for the experiment.
    """

    time_series: "TimeSeriesInfo" = betterproto.message_field(1)
    """The value of the Time Series info."""


@dataclass(eq=False, repr=False)
class TimeSeriesServiceSetTimeSeriesInfoRequest(betterproto.Message):
    """
    ...
    time_series: "TimeSeriesInfo" = betterproto.message_field(2)
    """The value of the Time Series info."""


@dataclass(eq=False, repr=False)
class TimeSeriesServiceSetTimeSeriesInfoResponse(betterproto.Message):
    """
...
@dataclass(eq=False, repr=False)
class TimeSeriesServiceTimeSeriesInfo(betterproto.Message):
    """Object representing the value of TimeSeriesInfo for the experiment."""

    duration: float = betterproto.double_field(1)
    """The value of the Duration."""

    duration_unit: "TimeSeriesServiceTimeUnitExtended" = betterproto.enum_field(2)
    """The value of the Duration Unit of measure."""
    ...
    interval_unit: "TimeSeriesServiceTimeUnit" = betterproto.enum_field(5)
    """The value of the Interval Uunit of measure."""
...
class DefiniteFocusServiceStub(betterproto.ServiceStub):
    async def find_surface(
        self,
        definite_focus_service_find_surface_request: "DefiniteFocusServiceFindSurfaceRequest",
        *,
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.DefiniteFocusService/FindSurface",
            definite_focus_service_find_surface_request,
            DefiniteFocusServiceFindSurfaceResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def lock_focus(
        self,
        definite_focus_service_lock_focus_request: "DefiniteFocusServiceLockFocusRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.DefiniteFocusService/LockFocus",
            definite_focus_service_lock_focus_request,
            DefiniteFocusServiceLockFocusResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def recall_focus(
        self,
        definite_focus_service_recall_focus_request: "DefiniteFocusServiceRecallFocusRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.DefiniteFocusService/RecallFocus",
            definite_focus_service_recall_focus_request,
            DefiniteFocusServiceRecallFocusResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def store_focus(
        self,
        definite_focus_service_store_focus_request: "DefiniteFocusServiceStoreFocusRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.DefiniteFocusService/StoreFocus",
            definite_focus_service_store_focus_request,
            DefiniteFocusServiceStoreFocusResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def unlock_focus(
        self,
        definite_focus_service_unlock_focus_request: "DefiniteFocusServiceUnlockFocusRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.DefiniteFocusService/UnlockFocus",
            definite_focus_service_unlock_focus_request,
            DefiniteFocusServiceUnlockFocusResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
...
class ExperimentSwAutofocusServiceStub(betterproto.ServiceStub):
    async def export(
        ...
        *,
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.ExperimentSwAutofocusService/Export",
    ...
    async def find_auto_focus(
        ...
        *,
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.ExperimentSwAutofocusService/FindAutoFocus",
    ...
    async def get_autofocus_parameters(
        ...
        *,
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.ExperimentSwAutofocusService/GetAutofocusParameters",
    ...
    async def import_(
        ...
        *,
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.ExperimentSwAutofocusService/Import",
    ...
    async def set_autofocus_parameters(
        ...
        *,
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.ExperimentSwAutofocusService/SetAutofocusParameters",
...
class TilesServiceStub(betterproto.ServiceStub):
    async def add_ellipse_tile_region(
        ...
        *,
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.TilesService/AddEllipseTileRegion",
    ...
    async def add_polygon_tile_region(
        ...
        *,
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.TilesService/AddPolygonTileRegion",
    ...
    async def add_positions(
        ...
        *,
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.TilesService/AddPositions",
    ...
    async def add_rectangle_tile_region(
        ...
        *,
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.TilesService/AddRectangleTileRegion",
    ...
    async def clear(
        ...
        *,
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.TilesService/Clear",
    ...
    async def is_tiles_experiment(
        ...
        *,
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.TilesService/IsTilesExperiment",
...
class TimeSeriesServiceStub(betterproto.ServiceStub):
    async def get_time_series_info(
        self,
        time_series_service_get_time_series_info_request: "TimeSeriesServiceGetTimeSeriesInfoRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.TimeSeriesService/GetTimeSeriesInfo",
            time_series_service_get_time_series_info_request,
            TimeSeriesServiceGetTimeSeriesInfoResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def set_time_series_info(
        self,
        time_series_service_set_time_series_info_request: "TimeSeriesServiceSetTimeSeriesInfoRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.TimeSeriesService/SetTimeSeriesInfo",
            time_series_service_set_time_series_info_request,
            TimeSeriesServiceSetTimeSeriesInfoResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
...
class TrackServiceStub(betterproto.ServiceStub):
    async def activate_channel(
        ...
        *,
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.TrackService/ActivateChannel",
    ...
    async def activate_track(
        ...
        *,
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.TrackService/ActivateTrack",
    ...
    async def deactivate_channel(
        ...
        *,
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.TrackService/DeactivateChannel",
    ...
    async def deactivate_track(
        ...
        *,
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.TrackService/DeactivateTrack",
    ...
    async def get_track_info(
        ...
        *,
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.TrackService/GetTrackInfo",
...
class ZStackServiceStub(betterproto.ServiceStub):
    async def get_z_stack_info(
        ...
        *,
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.ZStackService/GetZStackInfo",
    ...
    async def is_z_stack_experiment(
        ...
        *,
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.ZStackService/IsZStackExperiment",
    ...
    async def modify_z_stack_center_range(
        ...
        *,
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.ZStackService/ModifyZStackCenterRange",
    ...
    async def modify_z_stack_first_last(
        ...
        *,
        ...
        return await self._unary_unary(
            "/zen_api.lm.acquisition.v1.ZStackService/ModifyZStackFirstLast",
...
class DefiniteFocusServiceBase(ServiceBase):
    ...
    async def __rpc_find_surface(
        self,
        stream: "grpclib.server.Stream[DefiniteFocusServiceFindSurfaceRequest, DefiniteFocusServiceFindSurfaceResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.find_surface(request)
        await stream.send_message(response)

    async def __rpc_lock_focus(
        self,
        stream: "grpclib.server.Stream[DefiniteFocusServiceLockFocusRequest, DefiniteFocusServiceLockFocusResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.lock_focus(request)
        await stream.send_message(response)

    async def __rpc_recall_focus(
        self,
        stream: "grpclib.server.Stream[DefiniteFocusServiceRecallFocusRequest, DefiniteFocusServiceRecallFocusResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.recall_focus(request)
        await stream.send_message(response)

    async def __rpc_store_focus(
        self,
        stream: "grpclib.server.Stream[DefiniteFocusServiceStoreFocusRequest, DefiniteFocusServiceStoreFocusResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.store_focus(request)
        await stream.send_message(response)

    async def __rpc_unlock_focus(
        self,
        stream: "grpclib.server.Stream[DefiniteFocusServiceUnlockFocusRequest, DefiniteFocusServiceUnlockFocusResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.unlock_focus(request)
        await stream.send_message(response)

    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/zen_api.lm.acquisition.v1.DefiniteFocusService/FindSurface": grpclib.const.Handler(
                self.__rpc_find_surface,
                grpclib.const.Cardinality.UNARY_UNARY,
                DefiniteFocusServiceFindSurfaceRequest,
                DefiniteFocusServiceFindSurfaceResponse,
            ),
            "/zen_api.lm.acquisition.v1.DefiniteFocusService/LockFocus": grpclib.const.Handler(
                self.__rpc_lock_focus,
                grpclib.const.Cardinality.UNARY_UNARY,
                DefiniteFocusServiceLockFocusRequest,
                DefiniteFocusServiceLockFocusResponse,
            ),
            "/zen_api.lm.acquisition.v1.DefiniteFocusService/RecallFocus": grpclib.const.Handler(
                self.__rpc_recall_focus,
                grpclib.const.Cardinality.UNARY_UNARY,
                DefiniteFocusServiceRecallFocusRequest,
                DefiniteFocusServiceRecallFocusResponse,
            ),
            "/zen_api.lm.acquisition.v1.DefiniteFocusService/StoreFocus": grpclib.const.Handler(
                self.__rpc_store_focus,
                grpclib.const.Cardinality.UNARY_UNARY,
                DefiniteFocusServiceStoreFocusRequest,
                DefiniteFocusServiceStoreFocusResponse,
            ),
            "/zen_api.lm.acquisition.v1.DefiniteFocusService/UnlockFocus": grpclib.const.Handler(
                self.__rpc_unlock_focus,
                grpclib.const.Cardinality.UNARY_UNARY,
...
class ExperimentSwAutofocusServiceBase(ServiceBase):
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/zen_api.lm.acquisition.v1.ExperimentSwAutofocusService/Export": grpclib.const.Handler(
                self.__rpc_export,
                grpclib.const.Cardinality.UNARY_UNARY,
                ExperimentSwAutofocusServiceExportRequest,
                ExperimentSwAutofocusServiceExportResponse,
            ),
            "/zen_api.lm.acquisition.v1.ExperimentSwAutofocusService/FindAutoFocus": grpclib.const.Handler(
                self.__rpc_find_auto_focus,
                grpclib.const.Cardinality.UNARY_UNARY,
                ExperimentSwAutofocusServiceFindAutoFocusRequest,
                ExperimentSwAutofocusServiceFindAutoFocusResponse,
            ),
            "/zen_api.lm.acquisition.v1.ExperimentSwAutofocusService/GetAutofocusParameters": grpclib.const.Handler(
                self.__rpc_get_autofocus_parameters,
                grpclib.const.Cardinality.UNARY_UNARY,
                ExperimentSwAutofocusServiceGetAutofocusParametersRequest,
                ExperimentSwAutofocusServiceGetAutofocusParametersResponse,
            ),
            "/zen_api.lm.acquisition.v1.ExperimentSwAutofocusService/Import": grpclib.const.Handler(
                self.__rpc_import_,
                grpclib.const.Cardinality.UNARY_UNARY,
                ExperimentSwAutofocusServiceImportRequest,
                ExperimentSwAutofocusServiceImportResponse,
            ),
            "/zen_api.lm.acquisition.v1.ExperimentSwAutofocusService/SetAutofocusParameters": grpclib.const.Handler(
...
class TilesServiceBase(ServiceBase):
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/zen_api.lm.acquisition.v1.TilesService/AddEllipseTileRegion": grpclib.const.Handler(
                self.__rpc_add_ellipse_tile_region,
                grpclib.const.Cardinality.UNARY_UNARY,
                TilesServiceAddEllipseTileRegionRequest,
                TilesServiceAddEllipseTileRegionResponse,
            ),
            "/zen_api.lm.acquisition.v1.TilesService/AddPolygonTileRegion": grpclib.const.Handler(
                self.__rpc_add_polygon_tile_region,
                grpclib.const.Cardinality.UNARY_UNARY,
                TilesServiceAddPolygonTileRegionRequest,
                TilesServiceAddPolygonTileRegionResponse,
            ),
            "/zen_api.lm.acquisition.v1.TilesService/AddPositions": grpclib.const.Handler(
                self.__rpc_add_positions,
                grpclib.const.Cardinality.UNARY_UNARY,
                TilesServiceAddPositionsRequest,
                TilesServiceAddPositionsResponse,
            ),
            "/zen_api.lm.acquisition.v1.TilesService/AddRectangleTileRegion": grpclib.const.Handler(
                self.__rpc_add_rectangle_tile_region,
                grpclib.const.Cardinality.UNARY_UNARY,
                TilesServiceAddRectangleTileRegionRequest,
                TilesServiceAddRectangleTileRegionResponse,
            ),
            "/zen_api.lm.acquisition.v1.TilesService/Clear": grpclib.const.Handler(
                self.__rpc_clear,
                grpclib.const.Cardinality.UNARY_UNARY,
                TilesServiceClearRequest,
                TilesServiceClearResponse,
            ),
            "/zen_api.lm.acquisition.v1.TilesService/IsTilesExperiment": grpclib.const.Handler(
...
class TimeSeriesServiceBase(ServiceBase):
    ...
    async def __rpc_get_time_series_info(
        self,
        stream: "grpclib.server.Stream[TimeSeriesServiceGetTimeSeriesInfoRequest, TimeSeriesServiceGetTimeSeriesInfoResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_time_series_info(request)
        await stream.send_message(response)

    async def __rpc_set_time_series_info(
        self,
        stream: "grpclib.server.Stream[TimeSeriesServiceSetTimeSeriesInfoRequest, TimeSeriesServiceSetTimeSeriesInfoResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.set_time_series_info(request)
        await stream.send_message(response)

    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/zen_api.lm.acquisition.v1.TimeSeriesService/GetTimeSeriesInfo": grpclib.const.Handler(
                self.__rpc_get_time_series_info,
                grpclib.const.Cardinality.UNARY_UNARY,
                TimeSeriesServiceGetTimeSeriesInfoRequest,
                TimeSeriesServiceGetTimeSeriesInfoResponse,
            ),
            "/zen_api.lm.acquisition.v1.TimeSeriesService/SetTimeSeriesInfo": grpclib.const.Handler(
                self.__rpc_set_time_series_info,
                grpclib.const.Cardinality.UNARY_UNARY,
...
class TrackServiceBase(ServiceBase):
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/zen_api.lm.acquisition.v1.TrackService/ActivateChannel": grpclib.const.Handler(
                self.__rpc_activate_channel,
                grpclib.const.Cardinality.UNARY_UNARY,
                TrackServiceActivateChannelRequest,
                TrackServiceActivateChannelResponse,
            ),
            "/zen_api.lm.acquisition.v1.TrackService/ActivateTrack": grpclib.const.Handler(
                self.__rpc_activate_track,
                grpclib.const.Cardinality.UNARY_UNARY,
                TrackServiceActivateTrackRequest,
                TrackServiceActivateTrackResponse,
            ),
            "/zen_api.lm.acquisition.v1.TrackService/DeactivateChannel": grpclib.const.Handler(
                self.__rpc_deactivate_channel,
                grpclib.const.Cardinality.UNARY_UNARY,
                TrackServiceDeactivateChannelRequest,
                TrackServiceDeactivateChannelResponse,
            ),
            "/zen_api.lm.acquisition.v1.TrackService/DeactivateTrack": grpclib.const.Handler(
                self.__rpc_deactivate_track,
                grpclib.const.Cardinality.UNARY_UNARY,
                TrackServiceDeactivateTrackRequest,
                TrackServiceDeactivateTrackResponse,
            ),
            "/zen_api.lm.acquisition.v1.TrackService/GetTrackInfo": grpclib.const.Handler(
...
class ZStackServiceBase(ServiceBase):
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/zen_api.lm.acquisition.v1.ZStackService/GetZStackInfo": grpclib.const.Handler(
                self.__rpc_get_z_stack_info,
                grpclib.const.Cardinality.UNARY_UNARY,
                ZStackServiceGetZStackInfoRequest,
                ZStackServiceGetZStackInfoResponse,
            ),
            "/zen_api.lm.acquisition.v1.ZStackService/IsZStackExperiment": grpclib.const.Handler(
                self.__rpc_is_z_stack_experiment,
                grpclib.const.Cardinality.UNARY_UNARY,
                ZStackServiceIsZStackExperimentRequest,
                ZStackServiceIsZStackExperimentResponse,
            ),
            "/zen_api.lm.acquisition.v1.ZStackService/ModifyZStackCenterRange": grpclib.const.Handler(
                self.__rpc_modify_z_stack_center_range,
                grpclib.const.Cardinality.UNARY_UNARY,
                ZStackServiceModifyZStackCenterRangeRequest,
                ZStackServiceModifyZStackCenterRangeResponse,
            ),
            "/zen_api.lm.acquisition.v1.ZStackService/ModifyZStackFirstLast": grpclib.const.Handler(
