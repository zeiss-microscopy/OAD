...
from ...acquisition import v2 as __acquisition_v2__
...
@dataclass(eq=False, repr=False)
class RegionDefinition(betterproto.Message):
    """Represents definition of scan region."""

    contour: "__acquisition_v2__.RegionContour" = betterproto.message_field(1)
    """
    The region contour definition.
     The type of the contour can be:
     ZenApi.LM.Acquisition.V2.RegionRectangle, ZenApi.LM.Acquisition.V2.RegionEllipse or ZenApi.LM.Acquisition.V2.RegionPolygon.
    """


@dataclass(eq=False, repr=False)
class ScanProfileOptionsOverride(betterproto.Message):
    """Data container for overriding options of a scan profile."""

    make_prescan_preview: Optional[bool] = betterproto.message_field(
        1, wraps=betterproto.TYPE_BOOL
    )
    """
    A value indicating whether the prescan preview should be made or only a preview with the preview cam.
     If set to perform a prescan, the prescan will be done according to existing settings in the scan profile
     without modifications (resp. default settings will be used).
    """

    use_manual_segmentation: Optional[bool] = betterproto.message_field(
        2, wraps=betterproto.TYPE_BOOL
    )
    """
    A value indicating whether the segmentation mode shall be manual.
     If not set or set to false, the segmentation will be performed as defined in the scan profile.
    """

    disable_label_detection: Optional[bool] = betterproto.message_field(
        3, wraps=betterproto.TYPE_BOOL
    )
    """
    A value indicating whether the label detection shall be disabled.
     If set to true, the barcode and ocr recognition will be disabled.
     If not set or set to false, the label detection will be performed as defined in the scan profile.
    """
...
@dataclass(eq=False, repr=False)
class SlideScanServiceGetStorageFolderRequest(betterproto.Message):
    """
...
@dataclass(eq=False, repr=False)
class SlideScanServiceGetStorageFolderResponse(betterproto.Message):
    """
...
@dataclass(eq=False, repr=False)
class SlideScanServiceSetStorageFolderRequest(betterproto.Message):
    """
    Describes the input parameters for setting the storage folder for slide scans.
    """

    path: str = betterproto.string_field(1)
    """The path to the storage folder where slide scans should be stored."""


@dataclass(eq=False, repr=False)
class SlideScanServiceSetStorageFolderResponse(betterproto.Message):
...
class SlideScanServiceStartScanPreviewRequest(betterproto.Message):
    ...
    scan_profile_options_override: "ScanProfileOptionsOverride" = (
        betterproto.message_field(3)
    )
    """Optional overrides for scan profile options."""
...
class SlideScanServiceStartScanProfileRequest(betterproto.Message):
    ...
    region_definitions: List["RegionDefinition"] = betterproto.message_field(4)
    """The list of region contour definition."""
...
@dataclass(eq=False, repr=False)
class SlideScanServiceUnmarkSlidesRequest(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class SlideScanServiceUnmarkSlidesResponse(betterproto.Message):
...
class SlideScanServiceStub(betterproto.ServiceStub):
    ...
    async def get_storage_folder(
        self,
        slide_scan_service_get_storage_folder_request: "SlideScanServiceGetStorageFolderRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            "/zen_api.lm.slide_scan.v1.SlideScanService/GetStorageFolder",
            slide_scan_service_get_storage_folder_request,
            SlideScanServiceGetStorageFolderResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def set_storage_folder(
        self,
        slide_scan_service_set_storage_folder_request: "SlideScanServiceSetStorageFolderRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            "/zen_api.lm.slide_scan.v1.SlideScanService/SetStorageFolder",
            slide_scan_service_set_storage_folder_request,
            SlideScanServiceSetStorageFolderResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def unmark_slides(
        self,
        slide_scan_service_unmark_slides_request: "SlideScanServiceUnmarkSlidesRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            "/zen_api.lm.slide_scan.v1.SlideScanService/UnmarkSlides",
            slide_scan_service_unmark_slides_request,
            SlideScanServiceUnmarkSlidesResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
...
class SlideScanServiceBase(ServiceBase):
    ...
    async def __rpc_get_storage_folder(
        self,
        stream: "grpclib.server.Stream[SlideScanServiceGetStorageFolderRequest, SlideScanServiceGetStorageFolderResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_storage_folder(request)
        await stream.send_message(response)
    ...
    async def __rpc_set_storage_folder(
        self,
        stream: "grpclib.server.Stream[SlideScanServiceSetStorageFolderRequest, SlideScanServiceSetStorageFolderResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.set_storage_folder(request)
        await stream.send_message(response)
    ...
    async def __rpc_unmark_slides(
        self,
        stream: "grpclib.server.Stream[SlideScanServiceUnmarkSlidesRequest, SlideScanServiceUnmarkSlidesResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.unmark_slides(request)
        await stream.send_message(response)
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            ...
            "/zen_api.lm.slide_scan.v1.SlideScanService/GetStorageFolder": grpclib.const.Handler(
                self.__rpc_get_storage_folder,
                grpclib.const.Cardinality.UNARY_UNARY,
            ...
            "/zen_api.lm.slide_scan.v1.SlideScanService/SetStorageFolder": grpclib.const.Handler(
                self.__rpc_set_storage_folder,
                grpclib.const.Cardinality.UNARY_UNARY,
            ...
            "/zen_api.lm.slide_scan.v1.SlideScanService/UnmarkSlides": grpclib.const.Handler(
                self.__rpc_unmark_slides,
                grpclib.const.Cardinality.UNARY_UNARY,
